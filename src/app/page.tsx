        ...
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <div className="gap-2 gap-y-6 flex flex-col md:flex-row justify-between">
            ...
            <BlurFadeText
              ...
              >
                Hola, soy{" "}
                <span className="text-[#3e5b99] dark:text-[#F6E9B2]">
                  {DATA.name.split(" ")[0]}
                </span>
              </BlurFadeText>
              <BlurFadeText
                className="max-w-150 md:text-lg lg:text-xl text-muted-foreground dark:prose-invert"
                delay={BLUR_FADE_DELAY}
                text={DATA.description}
              />
            </div>
            <BlurFade delay={BLUR_FADE_DELAY} className="order-1 md:order-2">
              <Avatar className="size-24 md:size-32 border rounded-full shadow-lg ring-4 ring-[#a0b7e996] dark:ring-[#3e5b99]">
                <AvatarImage alt={DATA.name} src="/me.png" />
                <AvatarFallback className="bg-[#f2f2f2] text-[#070606] dark:bg-[#111] dark:text-[#FEFEFE]">
                  {DATA.initials}
                </AvatarFallback>
              </Avatar>
            </BlurFade>
      ...
      <section id="about">
        <div className="flex min-h-0 flex-col gap-y-4">
          <BlurFade delay={BLUR_FADE_DELAY * 3}>
            <h2 className="text-xl font-bold text-[#3e5b99] dark:text-[#F6E9B2]">Sobre mi</h2>
          </BlurFade>
      ...
      <section id="work">
        <div className="flex min-h-0 flex-col gap-y-6">
          <BlurFade delay={BLUR_FADE_DELAY * 5}>
            <h2 className="text-xl font-bold text-[#3e5b99] dark:text-[#F6E9B2]">Experiencia</h2>
          </BlurFade>
      ...
      <section id="education">
        <div className="flex min-h-0 flex-col gap-y-6">
          <BlurFade delay={BLUR_FADE_DELAY * 7}>
            <h2 className="text-xl font-bold text-[#3e5b99] dark:text-[#F6E9B2]">Educación</h2>
          </BlurFade>
